...
const UpdateRoom = () => {
    ...
    const [category, setCategory] = React.useState('King');
    const [guestCapacity, setGuestCapacity] = React.useState(1);
    const [numOfBeds, setNumOfBeds] = React.useState(1);
    const [internet, setInternet] = React.useState(false);
    const [breakfast, setBreakfast] = React.useState(false);
    const [airConditioned, setAirConditioned] = React.useState(false);
    const [petsAllowed, setPetsAllowed] = React.useState(false);
    const [roomCleaning, setRoomCleaning] = React.useState(false);

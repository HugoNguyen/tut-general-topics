import { LongProcessingRequestListener } from './events/listeners/long-processing-request-listener';
...
const start = async () => {
    ...
    try {
        ...
        new LongProcessingRequestListener(natsWrapper.client).listen();
    } catch (err) {
        console.error(err);
    }
};

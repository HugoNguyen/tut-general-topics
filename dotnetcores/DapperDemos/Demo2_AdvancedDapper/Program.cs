...
void MapMultipleObjectsWithParameters(string lastName)
{
    using (IDbConnection cnn = new SqlConnection(GetConnectionString()))
    {
        var p = new
...
void MultipleSetsWithParameters(string lastName, string partialPhoneNumber)
{
    using (IDbConnection cnn = new SqlConnection(GetConnectionString()))
    {
...
void OutputParameters(string firstName, string lastName)
{
    using (IDbConnection cnn = new SqlConnection(GetConnectionString()))
    {
